...
import { Alert, Card, CardBody, CardTitle, Button, CardSubtitle } from "reactstrap";
...
const PollCard = (props) => {
  ...
  return (
    ...
    {displayResultUser ? 
    <>
      <Button id="result" color="warning" onClick={seeResults} >See Results</Button>
      {resultArray.length > 0 ?
        <BarResult data={resultArray} question={props.poll.question} responses={[props.poll.response1,props.poll.response2,props.poll.response3,props.poll.response4]} /> : <></>
      }
    </>
    :
    <></>
